        ...
        <div className='w-full flex h-full overflow-hidden'>
            ...
            <div className='bg-[#343541] w-full h-full flex flex-col md:p-4 '>
                ...
                <form className='bg-[#343541] w-full max-h-[20rem] flex flex-col items-center justify-end gap-4 md:border-0 border-t-2 border-[#40414f] pt-4 md:py-0'>
                    <div className={`w-full max-h-full flex bg-[#40414f] p-2 relative md:w-[50rem] shadow-lg text-white items-${textAreaSize > 24 ? 'end' : 'center'}`}>
                        ...
                        <button className='absolute bottom-3 right-4'><PaperAirplaneIcon className='w-4' /></button>
                    </div>
